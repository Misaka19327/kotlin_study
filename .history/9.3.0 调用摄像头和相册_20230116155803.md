...
![1673855262844](image/9.3.0调用摄像头和相册/1673855262844.png)
...
差不多一个意思，回传了一个UriList，按着这段代码的样子取出来就行了。

另外一个，拍照回传的代码这里给一个比较规范的写法吧，之前不知道TakePicture也能传参数的：
