...
（回调，指一种函数之间的行为。举例来说就是，类A的方法调用了类B的方法，类B的方法执行结束之后主动执行类A的回调方法）
...
![1667133005924](image/3.3.0使用Intent在Activity之间穿梭/1667133005924.png)

有时，可能要返回数据的Activity没有按钮或者别的什么东西去创建intent，但是可以通过重写onBackPressed()来使得点击后退时创建intent：

![1667133382612](image/3.3.0使用Intent在Activity之间穿梭/1667133382612.png)
...
![1667133478487](image/3.3.0使用Intent在Activity之间穿梭/1667133478487.png)
