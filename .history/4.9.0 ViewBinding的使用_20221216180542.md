...
![1671184777682](image/4.9.0ViewBinding的使用/1671184777682.png)
...
首先，先调用activity_main布局文件对应的Binding类，使用它的inflate()加载这个布局，它接收一个LayoutInflater参数，这个参数是可以直接在activity中获取的；之后调用Binding类的getRoot()函数可以得到activity_main中根元素的实例
