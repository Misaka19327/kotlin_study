...
首先 在此处新建一个layout目录 并在该目录下新建一个first_layout布局文件（Layout Resouce File）

![1666851596881](image/3.2.0Activity的基本用法/1666851596881.png)![1666851703220](image/3.2.0Activity的基本用法/1666851703220.png)
