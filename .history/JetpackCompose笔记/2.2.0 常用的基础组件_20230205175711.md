...
在这个示例里，SpanStyle继承了TextStyle中关于文字样式相关的功能，ParagraphStyle继承了TextStyle中控制段落的部分。SpanStyle和ParagraphStyle分拆了TextStyle，可以对子串分别进行文字和段落样式的设置。另外，SpanStyle和ParagraphStyle中的设置是优先于整个TextStyle
