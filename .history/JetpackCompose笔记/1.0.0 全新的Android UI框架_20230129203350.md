...
![1674995253624](image/1.0.0全新的AndroidUI框架/1674995253624.png)
...
之后进行 Sync 操作，Sync之后就可以在项目中使用 Compose 了。因为 Compose 实际上都承载在 ComposeView上，如果想要在旧项目中加入 Compose，那么就需要在使用的 XML 布局文件的具体位置加一个 ComposeView。然后需要在对应 Activity 里查找该 View 并使用 setContent 即可。
