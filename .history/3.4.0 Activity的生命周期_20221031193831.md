...
现在假设一种情况，即我在MainActivity里启动了NormalActivity，此时系统因为内存不足，回收了MainActivity，然后我再返回MainActivity。这种情况下，MainActivity不会启动onRestart()，而是启动onCreate()重新打开MainActivity。
