...
修改了MainActivity和fruit_layout的代码即可达成网格布局。

![1669900393490](image/4.6.0更强大的滚动控件：RecyclerView/1669900393490.png)

![1669900404853](image/4.6.0更强大的滚动控件：RecyclerView/1669900404853.png)
...
在这里，LayoutManager是GridLayoutManager对象，它的构造函数需要上下文和用于指定列数的数字。

##### 3 RecyclerView的点击事件

与ListView直接注册监听器不同，RecyclerView需要给子项具体的View注册点击事件。

![1669898997302](image/4.6.0更强大的滚动控件：RecyclerView/1669898997302.png)
...
![1669899285127](image/4.6.0更强大的滚动控件：RecyclerView/1669899285127.png)
